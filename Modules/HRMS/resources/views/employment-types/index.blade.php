<x-hrms::layout.master>
    ...
    <x-common.card>
        ...
        <x-slot name="headerButton">
            <button class="btn btn-light-primary" data-bs-toggle="modal" id="modalopen" data-bs-target="#kt_modal_1">Add
                New
            </button>
        </x-slot>
    </x-common.card>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-0 pt-4">
                    <div class="mb-5">
                        ...
                        <input type="text" class="form-control form-control-solid" id="employementtype" name="input3"
                               placeholder="" value=""/>
