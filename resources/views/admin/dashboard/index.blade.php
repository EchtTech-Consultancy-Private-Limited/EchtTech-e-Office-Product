    ...
    <div class="container-fluid">
        <div class="row widget-grid">
            <div class="col-xxl-4 col-sm-6 box-col-6">
                <div class="card profile-box">
                    <div class="card-body">
                        <div class="media media-wrapper justify-content-between">
                            <div class="media-body">
                                <div class="greeting-user">
                                    <h4 class="f-w-600">Welcome to ECHT TECH Consultancy Services Pvt Ltd</h4>
                        ...
                        <div class="cartoon"><img class="img-fluid" src="{{ asset('assets/assets/images/dashboard/cartoon.svg') }}"
                            ...
                            <div class="card-body">
                                <div class="widget-content">
                                    <div class="widget-round secondary">
                                        <div class="bg-round">
                                            <svg class="svg-fill">
                                                <use href="{{ asset('assets/assets/svg/icon-sprite.svg#cart') }}"></use>
                                            </svg>
                                            <svg class="half-circle svg-fill">
                                                <use href="{{ asset('assets/assets/svg/icon-sprite.svg#halfcircle') }}"></use>
                                            </svg>
                                        </div>
                                    </div>
                                    <div>
                                ...
                                <div class="card-body">
                                    <div class="widget-content">
                                        <div class="widget-round primary">
                                            <div class="bg-round">
                                                <svg class="svg-fill">
                                                    <use href="{{ asset('assets/assets/svg/icon-sprite.svg#tag') }}"></use>
                                                </svg>
                                                <svg class="half-circle svg-fill">
                                                    <use href="{{ asset('assets/assets/svg/icon-sprite.svg#halfcircle') }}"></use>
                                                </svg>
                            ...
                            <div class="card-body">
                                <div class="widget-content">
                                    <div class="widget-round warning">
                                        <div class="bg-round">
                                            <svg class="svg-fill">
                                                <use href="{{ asset('assets/assets/svg/icon-sprite.svg#return-box') }}"></use>
                                            </svg>
                                            <svg class="half-circle svg-fill">
                                                <use href="{{ asset('assets/assets/svg/icon-sprite.svg#halfcircle') }}"></use>
                                            </svg>
                                ...
                                <div class="card-body">
                                    <div class="widget-content">
                                        <div class="widget-round success">
                                            <div class="bg-round">
                                                <svg class="svg-fill">
                                                    <use href="{{ asset('assets/assets/svg/icon-sprite.svg#rate') }}"></use>
                                                </svg>
                                                <svg class="half-circle svg-fill">
                                                    <use href="{{ asset('assets/assets/svg/icon-sprite.svg#halfcircle') }}"></use>
                                                </svg>
                                ...
                                <div class="row g-sm-4 g-2">
                                    <div class="col-xl-12 col-md-4">
                                        <div class="light-card balance-card widget-hover">
                                            <div class="svg-box">
                                                <svg class="svg-fill">
                                                    <use href="{{ asset('assets/assets/svg/icon-sprite.svg#income') }}"></use>
                                                </svg>
                                            </div>
                                            ...
                                            <div class="ms-auto text-end">
                                                ...
                                                <span class="font-success">+$456</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-md-4">
                                        <div class="light-card balance-card widget-hover">
                                            <div class="svg-box">
                                                <svg class="svg-fill">
                                                    <use href="{{ asset('assets/assets/svg/icon-sprite.svg#expense') }}"></use>
                                                </svg>
                                            </div>
                                            ...
                                            <div class="ms-auto text-end">
                                                ...
                                                <span class="font-danger">+$256</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-md-4">
                                        <div class="light-card balance-card widget-hover">
                                            <div class="svg-box">
                                                <svg class="svg-fill">
                                                    <use href="{{ asset('assets/assets/svg/icon-sprite.svg#doller-return') }}"></use>
                                                </svg>
                                            </div>
                                ...
                                <ul class="order-content">
                                    <li><span class="recent-circle bg-primary"> </span>
                                        <div><span class="f-light f-w-500">Cancelled </span>
                                            <h4 class="mt-1 mb-0">2,302<span class="f-light f-14 f-w-400 ms-1">(Last 6 Month) </span>
                                            </h4>
                                        </div>
                                    </li>
                                    <li><span class="recent-circle bg-info"></span>
                                        <div><span class="f-light f-w-500">Delivered</span>
                                            <h4 class="mt-1 mb-0">9,302<span class="f-light f-14 f-w-400 ms-1">(Last 6 Month) </span>
                                            </h4>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <div class="card-body pt-0">
                        <ul>
                            <li class="d-flex">
                                ...
                                <div class="w-100 ms-3">
                                    <p class="d-flex justify-content-between mb-2"><span
                                            class="date-content light-background">8th March, 2022 </span><span>1 day ago</span>
                                    </p>
                            ...
                            <li class="d-flex">
                                ...
                                <div class="w-100 ms-3">
                                    <p class="d-flex justify-content-between mb-2"><span
                                            class="date-content light-background">20th Sep, 2022 </span><span>12:00 PM</span>
                                    </p>
                                    <h6>Tello just like your product<span class="dot-notification"></span></h6>
                                    <p>Quisque a consequat ante sit amet magna... </p>
                                </div>
                                ...
                                <table class="table table-bordernone">
                                    ...
                                    <tr>
                                        <td><img class="img-fluid img-40 rounded-circle"
                                                 src="{{ asset('assets/assets/images/dashboard/user/1.jpg') }}" alt="user"></td>
                                        <td class="img-content-box"><a class="d-block f-w-500" href="user-profile.html">Jane
                                                Cooper</a><span class="f-light">10 minutes ago</span></td>
                                        <td class="text-end">
                                    ...
                                    <tr>
                                        <td><img class="img-fluid img-40 rounded-circle"
                                                 src="{{ asset('assets/assets/images/dashboard/user/2.jpg') }}" alt="user"></td>
                                        <td class="img-content-box"><a class="d-block f-w-500" href="user-profile.html">Brooklyn
                                                Simmons</a><span class="f-light">19 minutes ago</span></td>
                                        <td class="text-end">
                                    ...
                                    <tr>
                                        <td><img class="img-fluid img-40 rounded-circle"
                                                 src="{{ asset('assets/assets/images/dashboard/user/3.jpg') }}" alt="user"></td>
                                        <td class="img-content-box"><a class="d-block f-w-500" href="user-profile.html">Leslie
                                                Alexander</a><span class="f-light">2 hours ago</span></td>
                                        <td class="text-end">
                                    ...
                                    <tr>
                                        <td><img class="img-fluid img-40 rounded-circle"
                                                 src="{{ asset('assets/assets/images/dashboard/user/4.jpg') }}" alt="user"></td>
                                        <td class="img-content-box"><a class="d-block f-w-500" href="user-profile.html">Travis
                                                Wright</a><span class="f-light">8 hours ago</span></td>
                                        <td class="text-end">
                                    ...
                                    <tr>
                                        <td><img class="img-fluid img-40 rounded-circle"
                                                 src="{{ asset('assets/assets/images/dashboard/user/5.jpg') }}" alt="user"></td>
                                        <td class="img-content-box"><a class="d-block f-w-500" href="user-profile.html">Mark
                                                Green</a><span class="f-light">1 day ago</span></td>
                                        <td class="text-end">
            ...
            <div class="col-xxl-3 col-md-6 box-col-6 col-ed-none wow zoomIn">
                <div class="card purchase-card"><img class="img-fluid" src="{{ asset('assets/assets/images/dashboard/purchase.png') }}"
