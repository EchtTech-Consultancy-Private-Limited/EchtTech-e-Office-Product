                        ...
                        <div class="col-md-6">
                           ...
                           <div class="col-md-6">
                            ...
                            <label class="form-label">Degree Name</label>
                              <input type="text" id="employee_degree" class="form-control form-control-solid" name="input1" placeholder="" value=""/>
                           ...
                           <div class="mb-6 mt-6">
                            <label class="form-label">Course Title</label>
                              <input type="text" id="employee_course" class="form-control form-control-solid" name="input1" placeholder="" value=""/>
                           ...
                           <div class="col-md-6">
                            ...
                            <input type="file" id="emp_certificate_file" class="form-control form-control-solid" name="input1" placeholder="" value=""/>
                  ...
                  <div class="flex-column" data-kt-stepper-element="content">
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                           ...
                           <input type="text" class="form-control form-control-solid" id="wh_companyname" name="input1" placeholder="" value=""/>
                        ...
                        <div class="col-md-6">
                           ...
                           <input type="text" class="form-control form-control-solid" id="wh_department" name="input1" placeholder="" value=""/>
                        ...
                        <div class="col-md-6">
                           ...
                           <input type="text" class="form-control form-control-solid" id="wh_designation" name="input1" placeholder="" value=""/>
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="mb-6 mt-6">
                              ...
                              <input type="text" class="form-control form-control-solid" id="bnk_acctype" name="input1" placeholder="" value=""/>
