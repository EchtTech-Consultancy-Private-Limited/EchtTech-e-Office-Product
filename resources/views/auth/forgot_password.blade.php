            ...
            <div class="d-flex flex-center flex-column flex-column-fluid">
                ...
                <form action="{{ route('auth.checkForgotPassword') }}" method="POST" class="mt-4 mb-5" id="forgot_password_form">
                        ...
                        <div class="form-group mb-4">
                            <input id="forgot_password_captcha" type="text" class="form-control captcha" placeholder="Enter Captcha" name="captcha">
                        ...
                        @else
                                ...
                                <div id="varification" class="mt-3">
                                    <div class="position-relative">
                                        <h2 class="text-primary"><i class="text-primary fas fa-mobile-alt position-absolute start-0"></i></h3>
                                        <input type="hidden" name="email" value="{{$user->mobile_number}}" id="forgot_mobile_number">
                                        <span class="ms-4 ps-2"> <a href="#" id="reset_password_mobile_number" class="text-black">Get a verification code at +91 {{substr($user->mobile_number, 0, 2) }}******{{substr($user->mobile_number, -2) }} phone number</a></span>
                                    </div><br>
                                    <div class="text-blue-400 fw-bold fs-4 text-center">OR</div>
                                    <div class="position-relative">
                                        <h3 class="text-primary"><i class="text-primary fa fa-envelope-open-text position-absolute start-0"></i></h3>
                                        <input type="hidden" name="email" value="{{$user->email}}" id="forgot_email">
                                        <span class="ms-4 ps-2"><a href="#" class="text-black reset_password_email">Get a verification code at {{substr($user->email, 0, 2) }}*******{{substr($user->email, -12) }} email</a></span>
                                    </div>
                                </div>
                                @endif
                    </form>
        ...
        <div class="modal-dialog modal-dialog-centered modal" role="document">
            ...
            <div class="modal-content border-0">
                ...
                <div class="text mt-4 text-center">
                    ...
                    <img src="{{ asset('assets/media/svg/misc/smartphone.svg') }}" alt="" class="" width="80">
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <form action="{{ route('auth.verifyOtp') }}" method="POST" class="mt-4 input_formate_otp" id="verify_forgot_otp">
                                        ...
                                        <div class="otp-event text-center verification-code">
                                            ...
                                            <b><label class="control-label my-3"><span id="hidden_forgot_num"></span></label></b>
                                            ...
                                            <div class="verification-code otp-container inputs border-top-0">
                                                <input class="inputs otp-number-input keyword_1" type="text" name="verify_otp[]" id="otp-number-input-1" maxlength="1" required />
                                                <input class="inputs otp-number-input keyword_1" type="text" name="verify_otp[]" id="otp-number-input-2" maxlength="1" required />
                                                <input class="inputs otp-number-input keyword_1" type="text" name="verify_otp[]" id="otp-number-input-3" maxlength="1" required />
                                                <input class="inputs otp-number-input keyword_1" type="text" name="verify_otp[]" id="otp-number-input-4" maxlength="1" required />
                                        ...
                                        <div class="row text-center mt-3">
                                            <div class="col-md-12">
                                                <button type="button" name="" value="Verify" class="otp-submit verify_forgot_otp_btn btn btn-primary btn-sm">Verify</button>
                                                <div class="text-center">
                                                    ...
                                                    <a href="#" class="forgot_resend_sms disabled"><u>Resend OTP</u></a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
    ...
    <div id="emailModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal" role="document">
            <div class="modal-content border-0">
                ...
                <div class="text mt-4 text-center">
                    <h6 class="text-primary">Verification</h6>
                    <img src="{{ asset('assets/media/images/forgot.png')}}" alt="" class="" width="120">
                </div>
                <div class="modal-body pt-0 mb-3">
                    <div class="login-register">
                        <div class="tab-content">
                                ...
                                <div class="row">
                                    <form class="mt-4">
                                        <div class="verification-code text-center">
                                            ...
                                            <span class="text-black">We have sent a password recover<br> instructions to your email.</span><br>
